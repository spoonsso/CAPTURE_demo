...
#     k_pred_embedding = np.append(k_pred_embedding,reembedder.predict(test[:,2:]),axis=0)
...
final_embedding = reembedder.predict(features)
print("Total Time ReEmbedding: ", time.time()-start)
...
#     _, _, density_map = clustering(final_embedding, filename, sigma=sigma, bins_per_edge=5000)
